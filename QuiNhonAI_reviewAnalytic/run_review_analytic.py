...
def main():
    ...
    print(raw_datasets['train'][0]['review'])
    ...
    def compute_metrics(eval_pred):
        ...
        ra_score = ra_metric.compute(predictions=predictions, references=labels)
    ...
    if training_args.do_eval:
        ...
        for eval_dataset, task in zip(eval_datasets, tasks):
            ...
            metrics["eval_ra_score"] = metrics["eval_ra_score"]["ra_score"]
            metrics["eval_f1_score"] = metrics["eval_f1_score"]["f1"]

            trainer.log_metrics("eval", metrics)
            trainer.save_metrics("eval", metrics)
        # print(eval(trainer.model, trainer.get_eval_dataloader))
